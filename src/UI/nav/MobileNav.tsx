...
export const MobileNav: React.FC = () => {
    ...
    return (
        <React.Fragment>
            ...
            <MobileNavContainer closeMenu={closeMenu}>
                <CloseIcon onClick={() => setCloseMenu(true)}>
                    <Icon
...
const Overlay = styled.div<{ closeMenu: boolean }>`
    position: fixed;
    left: 0;
    top: 0;
    bottom: 0;
...
const MobileNavContainer = styled.div<{ closeMenu: boolean }>`
